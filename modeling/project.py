...
def get_discount(discounts):
    # valid current discount is the maximum among all active discounts
...
if __name__ == '__main__':
    items = Item.objects.select_related('item_cache').filter(
        item_cache__real_price__gte=1000,
        item_cache__real_price__lte=10000).order_by('item_cache__real_price')
